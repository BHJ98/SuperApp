  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-2 text-center">
        ...
        <div className="card">
          <p className="text-xs text-muted">4 weeks</p>
        ...
        <div className="card">
          ...
          <p className="text-xs text-muted">kg this week</p>
        </div>
      </div>
      ...
      <div className="card">
        ...
        {stats.setsByMuscle.length === 0 ? (
          <p className="text-sm text-muted">No working sets logged this week.</p>
        ) : (
