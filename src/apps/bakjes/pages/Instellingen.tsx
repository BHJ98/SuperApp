    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-wrap gap-2 items-center">
          ...
          <label
            className={`px-3 py-1.5 rounded border border-[var(--border)] text-sm cursor-pointer ${
              busy ? "opacity-60" : "hover:bg-subtle"
            }`}
          >
            Upload backup…
            <input
      ...
      <section className="card p-5 space-y-3">
        ...
        <div className="flex gap-2 items-center">
          ...
          <button
            onClick={wisEvents}
            className="px-3 py-1.5 rounded border border-danger text-danger text-sm"
          >
            Events wissen
          </button>
          {eventCount !== null && (
      ...
      {status && (
        <p className="text-sm text-ink bg-subtle rounded px-3 py-2">
          {status}
        </p>
      )}
    </div>
